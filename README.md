...
**Write-up:** [Where do NLA explanations preserve activation-specific causal effects?](pilots/wildcard-nla/output-validity/WRITEUP.md)

<p align="center">
  <img src="pilots/wildcard-nla/output-validity/figures/context-joint-specificity.png" alt="Same-variant joint specificity" width="720">
</p>
...
<p align="center">
  <img src="pilots/wildcard-nla/output-validity/figures/position-specificity.png" alt="Position-stratified specificity" width="720">
</p>
...
GPU jobs use the Slurm launchers in `code/run_nla_*.slurm`. Set `NLA_ROOT` to the repo root (default `$PWD`). Checkpoints are the released Hugging Face revisions in the write-up. Local weights are not checked in.

Runners:

- [`code/nla/run_output_validity_study.py`](code/nla/run_output_validity_study.py)
- [`code/nla/run_clause_ablation.py`](code/nla/run_clause_ablation.py)
- [`code/nla/run_context_baseline_study.py`](code/nla/run_context_baseline_study.py)
- [`code/nla/run_semantic_swap_study.py`](code/nla/run_semantic_swap_study.py)
